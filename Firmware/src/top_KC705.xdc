...
# 156.25MHz
create_clock -period 6.400 -name user_clock [get_ports USER_CLK_P]
# 125MHz
...
set_property PACKAGE_PIN AB8 [get_ports {LED8Bit[0]}]
...
set_property PACKAGE_PIN AA8 [get_ports {LED8Bit[1]}]
...
set_property PACKAGE_PIN AC9 [get_ports {LED8Bit[2]}]
...
set_property PACKAGE_PIN AB9 [get_ports {LED8Bit[3]}]
